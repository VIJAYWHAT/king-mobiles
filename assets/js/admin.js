...
window.createNewUser = async function (e) {
  ...
  if (editingUserUsername?.toLowerCase() === "admin" && currentUser.username?.toLowerCase() !== "admin") {
    showToast("Access Denied", "Only the primary superadmin can modify the @admin account.", "error");
    return;
  }
...
window.deleteUser = async function (username) {
  ...
  if (username.toLowerCase() === "admin") {
    showToast("Access Denied", "The primary superadmin account @admin cannot be deleted.", "error");
    return;
  }
...
window.editUser = function (username) {
  ...
  if (username.toLowerCase() === "admin" && currentUser.username?.toLowerCase() !== "admin") {
    showToast("Access Denied", "Only the primary superadmin can modify the @admin account.", "error");
    return;
  }
